...
//========================================
func string zCTexture_GetName(var int ptr) { // Actually not an engine call at all
    if(!ptr) { return ""; };
