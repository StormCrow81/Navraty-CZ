...
func void B_AssignORC_AntiPaladinTalk(var C_Npc Antipaladin)
{
	if(hero.guild == GIL_PAL)
	{
		...
		{
			AI_Output(self,other, " DIA_ORC_AntiPaladin_18_01 " );	// KHROKGNAR! Master say you are a paladin now! The leader is right. The leader is always right.
		...
		{
			AI_Output(self,other, " DIA_ORC_AntiPaladin_18_04 " );	// Master tell the orc leaders, bring the head of the great paladin. You die by my hand. KHROKGNAR!
		}
		else if(AntiPaladinTalkcount == 2)
		{
			AI_Output(self,other, " DIA_ORC_AntiPaladin_18_05 " );	// We, the leaders of the orcs, now come to kill you, paladin.
		}
		else
		{
			AI_Output(self,other, " DIA_ORC_AntiPaladin_18_06 " );	// KHROKGNAR! We kill you now, paladin.
		};
	}
	else
	{
