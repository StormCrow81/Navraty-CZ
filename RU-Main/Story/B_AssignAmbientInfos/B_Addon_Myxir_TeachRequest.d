...
func void B_DIA_Addon_Myxir_TeachL1()
{
	...
	AI_Output(self,other, " DIA_Addon_Myxir_TeachL1_12_02 " );	// This is the main language of the city. You can read most of the texts you find there if you master it.
};
...
func void B_DIA_Addon_Myxir_TeachL2()
{
	...
	AI_Output(self,other, " DIA_Addon_Myxir_TeachL2_12_01 " );	// Texts written in the language of warriors mainly deal with wars, weapons and martial arts.
};

func void B_DIA_Addon_Myxir_TeachL3()
{
	AI_Output(self,other, " DIA_Addon_Myxir_TeachL3_12_00 " );	// The high tongues of the priests is hard to understand. But I'll gladly teach it to you if I can.
	...
	AI_Output(self,other, " DIA_Addon_Myxir_TeachL3_12_02 " );	// Each of these texts is a treasure of arcane knowledge, if, of course, you can understand it.
};

func void B_DIA_Addon_Myxir_TeachNoMore()
{
	AI_Output(self,other, " DIA_Addon_Myxir_TeachNoMore_12_00 " );	// I have nothing more to show you. You have learned the language of the architects.
};
