...
func void DIA_BAU_1_JOIN_Info()
{
	...
	AI_Output(self,other, " DIA_BAU_1_JOIN_01_03 " );	// Of course, after that you can complain to Lee, but your nose will still be broken.
};
...
func void DIA_BAU_1_PEOPLE_Info()
{
	...
	AI_Output(self,other, " DIA_BAU_1_PEOPLE_01_02 " );	// Let me give you some advice: don't get into a fight with his mercenaries. Those guys are not to be trifled with.
	AI_Output(self,other, " DIA_BAU_1_PEOPLE_01_03 " );	// Silvio is a notorious bandit. But their leader, Lee, is a perfectly normal guy.
};
...
func void DIA_BAU_1_STANDARD_Info()
{
	...
	if (chapter ==  1 )
	{
		AI_Output(self,other, " DIA_BAU_1_STANDARD_01_01 " );	// Onar hired mercenaries to protect him from the city's militia. If not for the mercenaries, they would have taken everything from us, down to the last sheep!
	};
	if (chapter ==  2 )
	{
		AI_Output(self,other, " DIA_BAU_1_STANDARD_01_02 " );	// Not much. Same shit, different shade of brown. Militia, orcs and field predators.
	};
	if (chapter ==  3 )
	{
		AI_Output(self,other, " DIA_BAU_1_STANDARD_01_03 " );	// Strange things are happening here. A few days ago I saw a figure in black. It was no man, I know that in my soul.
	};
	if (chapter ==  4 )
	{
		AI_Output(self,other, " DIA_BAU_1_STANDARD_01_04 " );	// More and more orcs keep appearing. Sometimes it seems to me that for every orc killed, two more appear.
	};
	if (chapter ==  5 )
	{
		AI_Output(self,other, " DIA_BAU_1_STANDARZ_01_05 " );	// This plague of undead is driving me crazy! If this continues, we will all be walking corpses soon.
	};
	if (Chapter >=  6 )
	{
		AI_Output(self,other, " DIA_BAU_1_STANDARD_01_06 " );	// Orcs have captured Khorinis! It's over, do you understand? OVER!
	};
};
