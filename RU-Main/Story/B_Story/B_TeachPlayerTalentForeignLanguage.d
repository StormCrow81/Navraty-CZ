...
func int B_TeachPlayerTalentForeignLanguage(var C_Npc slf,var C_Npc oth,var int Language)
{
	...
	if(Language == LANGUAGE_1)
	{
		...
		AI_Print( " Studied the common language of the people of the Architects... " );
	...
	if(Language == LANGUAGE_2)
	{
		...
		AI_Print( " The language of the Builders warrior caste has been learned... " );
	...
	if(Language == LANGUAGE_3)
	{
		...
		AI_Print( " Learned the language of the Builders priest caste... " );
