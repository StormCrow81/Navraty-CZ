...
{
	AI_Output (self, other, " DIA_Ass_131_Adept_WithSlave_01_01 " );	// Why is it taking so long, novice ?! Master Nrozas was already waiting for his new slave.
...
func void DIA_Ass_131_Adept_NoSlave_Info ()
{
	...
	AI_Output (self, other, " DIA_Ass_131_Adept_NoSlave_01_04 " );	// What ?! (staring intently) Something tells me that you are not who you say you are.
...
func void DIA_Ass_131_Adept_NrozasPoisonGift_Info ()
{
	...
	AI_Output (self, other, " DIA_Ass_131_Adept_NrozasPoisonGift_01_02 " );	// So don't waste time and go to him immediately.
	AI_StopProcessInfos (self);
};
...
func void DIA_Ass_131_Adept_STANDARD_Info ()
{
	...
	else
	{
		if (randy ==  0 )
		{
			AI_Output (self, other, " DIA_ASS_1_STANDARD_01_00 " );	// Better leave! Otherwise, there will be in trouble ...
		};	
		if (randy ==  1 )
		{
