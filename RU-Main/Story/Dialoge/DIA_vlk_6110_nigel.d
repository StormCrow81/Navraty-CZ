...
func void dia_nigel_hallo_info()
{
	...
	AI_Output(other,self, " DIA_Nigel_Hallo_01_02 " );	// I'm the one sent to make you pay your bills. Or did you think it was easy to get off?
	AI_Output(self,other, " DIA_Nigel_Hallo_01_03 " );	// And where did you get the idea that I owe something to someone at all? And anyway, I don't understand what you're talking about.
	AI_Output(other,self, " DIA_Nigel_Hallo_01_04 " );	// Your name is Nigel, isn't it?
	AI_Output(self,other, " DIA_Nigel_Hallo_01_05 " );	// Well, yes, it's me.
	AI_Output(other,self, " DIA_Nigel_Hallo_01_06 " );	// So, I was not mistaken - you are exactly what I need. So stop playing dumb ass!
	AI_Output(other, self, " DIA_Nigel_Hallo_01_07 " );	// Pay me back, or you'll get in more trouble than you can imagine.
	AI_Output(self,other, " DIA_Nigel_Hallo_01_08 " );	// huh? (laughs) And how are you going to give me all this trouble?
	...
	AI_Output(self,other, " DIA_Nigel_Hallo_01_16 " );	// M-mmm... (thinks nervously)
	AI_Output(other,self, " DIA_Nigel_Hallo_01_17 " );	// I see that it's not very good - in your eyes there is only fear.
	AI_Output(self,other, " DIA_Nigel_Hallo_01_18 " );	// (doomed) Think and say what you want! You still won't get this money!
...
func void dia_nigel_hallo_kill()
{
	...
	AI_Output(other,self, " DIA_Nigel_Hallo_Kill_01_02 " );	// Everyone says so.	
	AI_Output(self,other, " DIA_Nigel_Hallo_Kill_01_03 " );	// (doomed) Damn... damn... damn!
	AI_StopProcessInfos(self);
...
func void dia_nigel_hallo_nokill()
{
	...
	AI_Output(other,self, " DIA_Nigel_Hallo_NoKill_01_03 " );	// You'll have to give them back anyway. I won't leave here without them.
	AI_Output(self,other, " DIA_Nigel_Hallo_Kill_01_03 " );	// (doomed) Damn... damn... damn!
	AI_Output(self,other, " DIA_Nigel_Hallo_NoKill_01_08 " );	// (doomed) But I don't have them...
	AI_Output(other,self, " DIA_Nigel_Hallo_NoKill_01_09 " );	// How not?!
	...
	AI_Output(self,other, " DIA_Nigel_Hallo_NoKill_01_14 " );	// But on the way between the tavern and the city, bandits attacked me. They took everything, including this money.
	Info_ClearChoices(dia_nigel_hallo);
...
func void dia_nigel_hallo_trust()
{
	...
	AI_Output(self,other, " DIA_Nigel_Hallo_Trust_01_09 " );	// I really hope so! If you manage to get this gold back, return it to the merchant.
	...
	AI_Output(self,other, " DIA_Nigel_Hallo_Trust_01_12 " );	// Well... (cautiously) I certainly can't count on you returning them to me...
...
func void dia_nigel_hallo_deal()
{
	...
	AI_Output(self,other, " DIA_Nigel_Hallo_Deal_01_06 " );	// True, as you can see, all this is fraught with great risk. The area is just teeming with robbers!
...
{
	AI_Output(other,self, " DIA_Nigel_Hallo_DealBad_01_00 " );	// Too few! I won't waste time on such trifles.
	AI_Output(self,other, " DIA_Nigel_Hallo_NoDeal_01_01 " );	// As you say, it's up to you. But if you do change your mind, you know where to find me.
	AI_Output(other,self, " DIA_Nigel_Hallo_NoDeal_01_02 " );	// I don't think I'll change my mind. But trust me, I won't forget about you. Especially if you lied to me about the bandits.
	AI_Output(self,other, " DIA_Nigel_Hallo_NoDeal_01_03 " );	// (nervously) Why would I lie?
	AI_Output(self,other, " DIA_Nigel_Hallo_NoDeal_01_06 " );	// Hope you get that gold back.
...
{
	AI_Output(other,self, " DIA_Nigel_Hallo_DealYes_01_00 " );	// Good. Consider that we have agreed.
	...
	B_LogEntry( TOPIC_NIGELMATTER , " Nigel made me an offer: if I return the money to him, he wants to put it into circulation, and part of the profit that he will get from this will be mine. I decided to agree. And let Asmal wait with his debt. It remains to figure it out with the bandits who robbed Nigel and bring him a wallet. " );
	AI_StopProcessInfos(self);
	Wld_InsertNpc(bdt_6121_nigelband_01,"NW_CITY_TO_FOREST_04_08");
	Wld_InsertNpc(bdt_6122_nigelband_02,"NW_CITY_TO_FOREST_04_09");
	Wld_InsertNpc(bdt_6123_nigelband_03,"NW_BDT_NIGEL_03");
...
func void dia_nigel_moneyback_info()
{
	...
	AI_Output(self,other, " DIA_Nigel_MoneyBack_01_01 " );	// (joyfully) Wow! It really is him. How did you manage that?
	AI_Output(other,self, " DIA_Nigel_MoneyBack_01_02 " );	// You better not know.
	AI_Output(self,other, " DIA_Nigel_MoneyBack_01_03 " );	// Okay, you don't have to tell. The main thing is that you were able to return this money to me, and now you can safely get down to business again.
	...
	AI_Output(self,other, " DIA_Nigel_MoneyBack_01_16 " );	// You can find me at Onar's farm, I'll be there all the time.
...
func void dia_nigel_moneynow_info()
{
	...
	if(NIGELMATTERDAY <= (daynow - 3))
	{
		...
		AI_Output(self,other, " DIA_Nigel_MoneyNow_01_03 " );	// Well, what do you say now? No wonder you agreed to my proposal?
		AI_Output(other,self, " DIA_Nigel_MoneyNow_01_04 " );	// Yes, it seems not in vain. Your business really turned out to be quite profitable.
		...
		if (( TRADEGUILD MEMBER  ==  FALSE ) && ( MY_TRADEGUILD  !=  LOG_FAILED ) && ( NIGELTELLABOUTGUILD  ==  FALSE ) && ( EROLTELLABOUTGUILD  ==  FALSE ))
		{
			...
			AI_Output(self,other, " DIA_Nigel_MoneyNow_01_11 " );	// But in vain! I think you have a talent for this business.
			...
			AI_Output(self,other, " DIA_Nigel_MoneyNow_01_23 " );	// Of course I didn't! Everyone who is in it, try not to talk too much about it. Especially in these turbulent times.
			AI_Output(other,self, " DIA_Nigel_MoneyNow_01_25 " );	// And what will I tell him?
			AI_Output(self,other, " DIA_Nigel_MoneyNow_01_26 " );	// You don't need to say anything special. I will tell everything for you in this letter.
			AI_Output(other,self, " DIA_Nigel_MoneyNow_01_28 " );	// Will he accept me into the merchants guild?
			AI_Output(self,other, " DIA_Nigel_MoneyNow_01_29 " );	// Well, yes. Why are you so surprised? (laughs)
			...
			AI_Output(self,other, " DIA_Nigel_MoneyNow_01_37 " );	// Yes, to him. You probably already know him and know where he lives.
