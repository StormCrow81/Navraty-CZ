...
func void dmt_1212_dagot_hello_info()
{
	...
	AI_Output (self, other, " DMT_1212_Dagot_Hello_03 " );	// Xardas has told me a lot about you. Few of the heroes of this world have succeeded in such a thing!
	...
	AI_Output (self, other, " DMT_1212_Dagot_Hello_16 " );	// That shouldn't worry you right now. As well as the reason for my stay here.
	...
	AI_Output (self, other, " DMT_1212_Dagot_Hello_34 " );	// The Sacred Halls of Bacchan ... The ancients called them the 'Halls of Chaos'. This is a place where there is nothing but emptiness ...
...
func void dmt_1212_dagot_hello_no()
{
	...
	AI_Output (self, other, " DMT_1212_Dagot_Hello_52 " );	// Your answer disappoints me greatly. But this is exactly how it should have been.
...
func void dmt_1212_dagot_hellotwo_info()
{
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_07 " );	// My presence here, like our first meeting, means that it's time for you to learn more about us - the Guardians ...
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_16 " );	// And they understood: in a reality ruled by Chaos, they would have no place. Only by breaking free of it, could they find peace.
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_20 " );	// So four fraternal deities came to this world ...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_21 " );	// Innos, born of flaming Fire and the light it creates, was the first of the brothers...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_22 " );	// The second was Beliar, emerged from the darkness that comes into being where light fades and cold seeps in...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_23 " );	// Adanos, spawned from the surface of the very first waters...
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_25 " );	// And these deities kept the secret of the seal and what is hidden behind it.
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_27 " );	// And it so happened that Beliar, having feuded with his brother Stonnos, killed him in desperate rage, becoming the first murderer ...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_28 " );	// And then there were three of them ... That is why the name of the fourth deity has been forgotten by the tongues of mortals.
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_30 " );	// Adanos did not take either the side of Innos, or the side of Beliar, but stood between them, identifying himself with the wisdom of neutrality in their confrontation.
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_33 " );	// And there was a danger that Chaos will again take possession of this world and plunge all life into the void of nothingness.
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_34 " );	// Then the primal elements that gave birth to these deities no longer wanted to behold at their enmity and feared the appearance of Chaos in this world ...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_35 " );	// ...They forced the three deities to each create a guardian from a piece of themselves ...
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_37 " );	// The elements themselves created one guard, endowing him with the power of the three and by the consent of the other elements ...
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_58 " );	// But, like all deities in this world, we, the Guardians, also have followers from the realms of the dead, who embody our thoughts and will.
	...
	AI_Output (self, other, " DMT_1212_Dagot_HelloTwo_75 " );	// He will explain to you what your Test of Faith is ... But for now you are still very far from that ...
	...
	Log_AddEntry ( TOPIC_GUARDIANS , " In one of the caves, I crossed paths with the Guardian again. Dagoth told me the legends of the past. I learned about the beginning of the world, about the gods, about the struggles of the gods, about the hatred of the gods, about the Guardians. About the sacred Circle of balance. " );
