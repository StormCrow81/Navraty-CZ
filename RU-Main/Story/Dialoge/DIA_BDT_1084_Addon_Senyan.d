...
{
	AI_Output(self,other, " DIA_Addon_Senyan_Attack_12_00 " );	// Then why do I still need you, parasite?
	AI_Output(self,other, " DIA_Addon_Senyan_Attack_12_01 " );	// Hey guys, look who we have here!
	Senyan_Called = TRUE;
	AI_StopProcessInfos(self);
...
func void B_Senyan_Blackmail()
{
	...
	AI_Output(self,other, " DIA_Addon_Senyan_Erpressung_12_01 " );	// Oh no, please don't. I don't want to extort money from you. I wouldn't even dream of it.
...
func void DIA_Addon_BDT_1084_Senyan_Hi_good()
{
	if ( New_Msg ==  FALSE )
	{
		AI_Output(other,self, " DIA_Addon_BDT_1084_Senyan_Hi_good_15_00 " );	// Good news first.
		Senyan_Msg = TRUE;
	}
	else
	{
...
func void DIA_Addon_BDT_1084_Senyan_Hi_bad()
{
	...
	AI_Output(self,other, " DIA_Addon_BDT_1084_Senyan_Hi_bad_12_02 " );	// Raven is looking for you, as well as his security. Actually, all the bandits are looking for you...
	...
	AI_Output(self,other, " DIA_Addon_BDT_1084_Senyan_Hi_bad_12_06 " );	// ...it's like coming to the wolves as a sheep. Your life hangs in the balance my friend.
	Senyan_Bad = TRUE;
	Info_ClearChoices(DIA_Addon_BDT_1084_Senyan_Hi);
	if(Senyan_Good == TRUE)
	{
...
func void DIA_Addon_Senyan_Attentat_Info()
{
	...
	AI_Output(self,other, " DIA_Addon_Senyan_Attentat_12_03 " );	// No more than you. I'm looking for him too. And here is where it gets interesting.
	AI_Output(other,self,"DIA_Addon_Senyan_Attentat_15_04");	//And?
	AI_Output(self,other, " DIA_Addon_Senyan_Attentat_12_05 " );	// I want you to complete your task. For you to find the traitor.
	AI_Output(self,other, " DIA_Addon_Senyan_Attentat_12_06 " );	// And when you find him, you will kill him for me.
	AI_Output(self,other, " DIA_Addon_Senyan_Attentat_12_07 " );	// And I'll take the reward.
	AI_Output(self,other, " DIA_Addon_Senyan_Attentat_12_08 " );	// I have a wanted poster for you - don't forget it. Do your job and do it well. You know what will happen otherwise.
...
func void DIA_Addon_Senyan_Attentat_JA()
{
	...
	AI_Output(self,other, " DIA_Addon_Senyan_Attentat_JA_12_02 " );	// When you've done your job - and done it well - and figured out who's to blame, we'll kill the bastard together. Now go!
...
{
	AI_Output(self,other, " DIA_Addon_BDT_1084_Senyan_derbe_12_00 " );	// You didn't honor our agreement...
	B_Senyan_Attack();
};
