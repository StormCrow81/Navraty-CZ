...
func void DIA_Rukhar_HELLO_Info()
{
	...
	AI_Output(self,other, " DIA_Rukhar_HALLO_12_01 " );	// Not the best, but don't get too picky these days.
};
...
func void DIA_Rukhar_WASMACHSTDU_Info()
{
	...
	AI_Output(self,other, " DIA_Rukhar_WASMACHSTDU_12_01 " );	// Until a few weeks ago, he worked like a slave on Onar's farm.
	AI_Output(self,other, " DIA_Rukhar_WASMACHSTDU_12_02 " );	// But one day I realized that I couldn't stand it anymore and ran away from there.
	...
	AI_Output(self,other, " DIA_Rukhar_WASMACHSTDU_12_04 " );	// Do you want to compete with me?
...
func void DIA_Rukhar_COMPETITION_Info()
{
	...
	AI_Output(self,other, " DIA_Rukhar_WETTKAMPF_12_01 " );	// I call it 'DRINK DOWN'!
	...
	AI_Output(self,other, " DIA_Rukhar_WETTKAMPF_12_04 " );	// Each mug needs to be drained to the bottom so that the table stays dry when turned upside down.
	AI_Output(self,other, " DIA_Rukhar_WETTKAMPF_12_05 " );	// Whoever can stand the longest wins. The loser pays for the beer and the bet. Well? How do you like it?
...
func void DIA_Rukhar_HOLERANDOLPH_Info()
{
	...
	B_LogEntry(TOPIC_Wettsaufen, " Ruhar calls this game DRINK TO THE BOTTOM. No thanks, I'm not interested. I'll find someone else for him. Let him fool others, but not me. " );
};
...
instance DIA_Rukhar_RANDOLPHWILL(C_Info)
{
	...
	permanent = TRUE;
	description = " I've found a man who wants to fight you. " ;
};
...
{
	AI_Output(other,self, " DIA_Rukhar_RANDOLPHWILL_15_00 " );	// I found a man who wants to fight you.
	...
	AI_Output(self,other, " DIA_Rukhar_RANDOLPHWILL_12_03 " );	// Ho, ho, ho... (laughs) Randolph the braggart?! OK then. Why not!
	...
	Info_AddChoice(DIA_Route_RANDOLPHWILL, " Boy " ,DIA_Root_RANDOLPHWILL_nix);
	...
	Info_AddChoice(DIA_Choice_RANDOLPHWILL, " 10 minutes " ,DIA_Choice_RANDOLPHWILL_10);
};
...
func void DIA_Rukhar_RANDOLPHWILL_nix()
{
	...
	AI_Output(self,other, " DIA_Rukhar_RANDOLPHWILL_nix_12_01 " );	// Then we'd better forget about the race.
	AI_StopProcessInfos(self);
};
...
func void DIA_Rukhar_RANDOLPHWILL_20()
{
	...
	AI_Output(self,other, " DIA_Rukhar_RANDOLPHWILL_20_12_01 " );	// If you want to bet, then do it like a human.
...
func void DIA_Rukhar_RANDOLPHWILL_50()
{
	...
	AI_Output(self,other, " DIA_Rukhar_RANDOLPHWILL_50_12_01 " );	// Don't be shy! Bolder.
...
func void DIA_Rukhar_RANDOLPHWILL_100()
{
	...
	AI_Output(self,other, " DIA_Rukhar_RANDOLPHWILL_100_12_01 " );	// I already like this!
...
func void DIA_Rukhar_ICHSEHEDICH_Info()
{
	...
	{
		AI_Output(self,other, " DIA_Rukhar_ICHSEHEDICH_12_01 " );	// Good. But just don't delay, bring Randolph quickly, do you hear?
	...
	{
		AI_Output(self,other, " DIA_Rukhar_ICHSEHEDICH_12_02 " );	// Very funny. Come back when you have money.
	};
	AI_StopProcessInfos(self);
};
...
func void DIA_Rukhar_HAENSELN_Info()
{
	...
	{
		AI_Output(self,other, " DIA_Rukhar_HAENSELN_12_02 " );	// I'll get even with you.
	};
