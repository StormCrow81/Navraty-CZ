...
func void DIA_Maleth_Hallo_Info()
{
	...
	if(hero.guild == GIL_NONE)
	{
		...
		AI_Output(self,other, " DIA_Maleth_Hallo_08_03 " );	// We'd take you for a runaway convict. And we have very short conversations with them!
		...
		else
		{
			...
			AI_Output(self,other, " DIA_Maleth_Hallo_08_06 " );	// Now you look like a man again!
		};
	};
...
func void DIA_Maleth_BANDITS_Info()
{
	...
	AI_Output(self,other, " DIA_Maleth_BANDITS_08_01 " );	// Those vile bastardsIt's probably the same bastards that have been stealing our sheep!
	AI_Output(self,other, " DIA_Maleth_BANDITS_08_02 " );	// You're very lucky. Few people manage to get away from them alive.
};
...
func void DIA_Maleth_BanditsDEAD_Info()
{
	...
	AI_Output(other,self, " DIA_Maleth_BanditsDEAD_15_02 " );	// Lets just say they didn't make it.
	AI_Output(self,other, " DIA_Maleth_BanditsDEAD_08_03 " );	// Glory to Innos! It's very little, but I want you to take it!
...
func void DIA_Maleth_BanditsALIVE_Info()
{
	...
	AI_Output(self,other, " DIA_Maleth_BanditsALIVE_08_01 " );	// Do you want to attack them? I won't be joining you! It's too dangerous!
	...
	B_LogEntry(TOPIC_Maleth, " If I destroy the bandits that settled halfway from Xardas' tower to Lobart's farm, all the inhabitants of the farm will be grateful to me. " );
};
...
func void DIA_Maleth_ToTheCity_Info()
{
	...
	if(Npc_HasEquippedArmor(other) == FALSE)
	{
		...
		AI_Output(self,other, " DIA_Maleth_ToTheCity_08_02 " );	// Or you could tell them what they want to hear.
	}
	else
	{
		AI_Output(self,other, " DIA_Maleth_ToTheCity_08_03 " );	// They can let you in - if you tell them what they want to hear...
	};
	AI_Output(other,self,"DIA_Maleth_ToTheCity_15_04");	//And that is?
	AI_Output(self,other, " DIA_Maleth_ToTheCity_08_05 " );	// Well, for example, that you are from Lobart's farm and are going to the city blacksmith.
	...
	AI_Output(other,self,"DIA_Maleth_ToTheCity_15_07");	//It's clear.
};
...
func void DIA_Maleth_Equipment_Info()
{
	...
	AI_Output(self,other, " DIA_Maleth_Equipment_08_01 " );	// Obviously. But I'll be honest with you: we don't have anything to share!
	if ( ! Npc_IsDead(Lobart))
	{
		AI_Output(self,other, " DIA_Maleth_Equipment_08_02 " );	// Although, if you can pay, Lobart will sell you something.
		AI_Output(self,other, " DIA_Maleth_Equipment_08_03 " );	// Or you can go to him and ask if he has any work.
	};
};
...
func void DIA_Maleth_LOBART_Info()
{
	...
	AI_Output(self,other, " DIA_Maleth_LOBART_08_02 " );	// And don't try to trick him! He has little patience for loafers.
};
...
func void DIA_Maleth_PROBLEME_Info()
{
	...
	AI_Output(self,other, " DIA_Maleth_PROBLEME_08_02 " );	// If you see a man in black, you will understand what's new.
	...
	Info_AddChoice(DIA_Maleth_PROBLEME, " Have the people in black robes visited you yet? " ,DIA_Maleth_PROBLEME_beidir);
};

func void DIA_Maleth_PROBLEME_beidir()
{
	AI_Output(other,self, " DIA_Maleth_PROBLEME_beidir_15_00 " );	// People in black robes haven't visited you yet?
	AI_Output(self,other, " DIA_Maleth_PROBLEME_beidir_08_01 " );	// Yes. They were here a few days ago. They look like they've risen from the void itself.
};

func void DIA_Maleth_PROBLEMS_sheep()
{
	AI_Output(other,self, " DIA_Maleth_PROBLEME_schafe_15_00 " );	// How are your sheep?
	AI_Output(self,other, " DIA_Maleth_PROBLEME_schafe_08_01 " );	// As if you're interested. You have your own problems.
	Info_AddChoice(DIA_Maleth_PROBLEME, " My problems? What do you mean? " ,DIA_Maleth_PROBLEME_schafe_probleme);
};

func void DIA_Maleth_PROBLEMS_sheep_problems()
{
	AI_Output(other,self, " DIA_Maleth_PROBLEME_schafe_probleme_15_00 " );	// My problems? What do you mean?
	if((hero.guild == GIL_MIL) || (hero.guild == GIL_PAL))
	{
		AI_Output(self,other, " DIA_Maleth_PROBLEME_schafe_probleme_08_01 " );	// Are you in the city guard or not? Then do something about those black-robed bastards.
	};
	if((hero.guild == GIL_SLD) || (hero.guild == GIL_DJG))
	{
		AI_Output(self,other, " DIA_Maleth_PROBLEME_schafe_probleme_08_02 " );	// You dirty mercenaries only think about one thing: how to put other people's money in your pockets.
	};
	if(hero.guild == GIL_KDF)
	{
		AI_Output(self,other, " DIA_Maleth_PROBLEME_schafe_probleme_08_03 " );	// You Pyromancers from the monastery should do something about these strangers in black.
	};
	if(hero.guild == GIL_KDW)
	{
		AI_Output(self,other, " DIA_Maleth_PROBLEME_schafe_probleme_08_04 " );	// You noble Waterbenders should do something against these guys in black robes for us.
	};
	if(hero.guild == GIL_KDM)
	{
		AI_Output(self,other, " DIA_Maleth_PROBLEME_schafe_probleme_08_05 " );	// Since when did dark Wizards become so compassionate?
	};
...
func void DIA_Maleth_PROBLEME_sheep_problems_money_here_order()
{
	...
	B_LogEntry(TOPIC_MalethsGehstock, " Maleth got drunk and lost his staff. As far as I know him, he never strayed far from Lobart's farm. Maybe I'll find it somewhere nearby. " );
	Info_ClearChoices(DIA_Maleth_PROBLEME);
};
...
func void DIA_Maleth_PROBLEMS_sheep_problems_threatening()
{
	...
	AI_Output(self,other, " DIA_Maleth_PROBLEME_schafe_probleme_drohen_08_01 " );	// All you can do is talk. It's best if you leave.
};
...
{
	AI_Output(other,self, " DIA_Maleth_GEHSTOCK_15_00 " );	// I think this is your staff.
	...
	Info_AddChoice(DIA_Maleth_WALKING STOCK, " Good. " ,DIA_Maleth_WALKING STOCK_ok);
};

func void DIA_Maleth_WALKING STOCK_ok()
{
	AI_Output(other,self,"DIA_Maleth_GEHSTOCK_ok_15_00");	//Good.
...
{
	AI_Output(other,self, " DIA_Maleth_GEHSTOCK_gold_15_00 " );	// Sorry, I'm not interested. All I want is what's in your pockets.
...
{
	AI_Output(other,self, " DIA_Maleth_PERM3_15_00 " );	// Hey, don't overwork yourself.
	AI_Output(self,other, " DIA_Maleth_PERM3_08_01 " );	// Get out!
	AI_StopProcessInfos(self);
};
