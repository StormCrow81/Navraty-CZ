...
func void dia_vlk_6133_maxi_hallo_info()
{
	...
	AI_Output(other,self, " DIA_VLK_6133_Maxi_Hallo_01_02 " );	// No, I don't have a job for you.
	AI_Output(self,other, " DIA_VLK_6133_Maxi_Hallo_01_03 " );	// Then why are you distracting me? Can't you see I'm busy!
	...
	AI_Output(self,other, " DIA_VLK_6133_Maxi_Hallo_01_06 " );	// And you start asking me about all sorts of nonsense, and thus distract me!
};
...
func void dia_vlk_6133_maxi_whatdo_info()
{
	...
	AI_Output(self,other, " DIA_VLK_6133_Maxi_WhatDo_01_03 " );	// I'm ready to take on any of their dirty work. I am well versed in menial tasks.
	...
	AI_Output(self,other, " DIA_VLK_6133_Maxi_WhatDo_01_08 " );	// Yes, I already worked for one merchant, but he recently went bankrupt, and I was left without work.
	AI_Output(self,other, " DIA_VLK_6133_Maxi_WhatDo_01_10 " );	// Now I'm looking for a new employer.
	AI_Output(other,self, " DIA_VLK_6133_Maxi_WhatDo_01_11 " );	// I guess you'll be here for a long time.
	AI_Output(self,other, " DIA_VLK_6133_Maxi_WhatDo_01_12 " );	// Yeah, yeah. Get lost.
	AI_StopProcessInfos(self);
};
...
{
	AI_Output(other,self,"DIA_VLK_6133_Maxi_Perm_01_00");	//What's up?
	AI_Output(self,other, " DIA_VLK_6133_Maxi_Perm_01_01 " );	// Do you care?
	AI_Output(other,self, " DIA_VLK_6133_Maxi_Perm_01_02 " );	// I may have a job for you.
	...
	AI_Output(self,other, " DIA_VLK_6133_Maxi_Perm_01_05 " );	// Ugh. What have I done to you that you keep getting on my nerves?
	AI_StopProcessInfos(self);
};
...
func void dia_vlk_6133_maxi_hire_info()
{
	...
	AI_Output(self,other, " DIA_VLK_6133_Maxi_Hire_01_01 " );	// Yes??
	AI_Output(other,self, " DIA_VLK_6133_Maxi_Hire_01_03 " );	// A large merchant from the upper quarter of the city is looking for a man to take the place of his assistant.
	AI_Output(other,self, " DIA_VLK_6133_Maxi_Hire_01_04 " );	// The job is to do all the thankless jobs for him and help him run the business.
	...
	AI_Output(self,other, " DIA_VLK_6133_Maxi_Hire_01_07 " );	// This is a great offer! I'll take it, of course!
	...
	AI_Output(self,other, " DIA_VLK_6133_Maxi_Hire_01_15 " );	// Okay, think about it, but not for long. Good workers like me don't roll around on the road for long.
	B_LogEntry( TOPIC_TRADEHELPER , " Maxie is willing to work as Luthero's assistant. Although maybe someone else will also be willing to take the job. " );
	MAXIAGREE = TRUE;
	AI_StopProcessInfos(self);
};
...
{
	AI_Output(other,self, " DIA_VLK_6133_Maxi_HireOk_01_00 " );	// Let's go to the merchant.
	AI_Output(other,self, " DIA_VLK_6133_Maxi_HireOk_01_01 " );	// I think you're the right person for him.
	AI_Output(self,other, " DIA_VLK_6133_Maxi_HireOk_01_02 " );	// Great!
