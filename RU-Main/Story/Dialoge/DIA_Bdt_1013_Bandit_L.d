...
func void dia_bdt_1013_bandit_where_mountain()
{
	...
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_MOUNTAIN_01_03 " );	// A whole bunch of nasty people are looking for you.
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_MOUNTAIN_01_04 " );	// There is a person with whom you just need to talk. Come with me!
	Info_ClearChoices(dia_bdt_1013_bandit_where);
...
func void dia_bdt_1013_bandit_where_xardas()
{
	...
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_XARDAS_01_01 " );	// The old mage? Brago will find this very interesting.
	AI_StopProcessInfos(self);
...
func void dia_bdt_1013_bandit_where_talkpartner()
{
	...
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_TALKPARTNER_01_02 " );	// Well then what are we waiting for?
	Info_ClearChoices(dia_bdt_1013_bandit_where);
	Info_AddChoice(dia_bdt_1013_bandit_where,"Perhaps later...",dia_bdt_1013_bandit_where_later);
...
{
	AI_Output(other,self, " DIA_BDT_1013_BANDIT_WHERE_DAMALS_15_00 " );	// Take it easy, mate! Someone already tried to trick me once...
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_DAMALS_01_01 " );	// Oh?
	AI_Output(other,self, " DIA_BDT_1013_BANDIT_WHERE_DAMALS_15_02 " );	// This guy suggested that we find an amulet together and share the income.
	AI_Output(other,self, " DIA_BDT_1013_BANDIT_WHERE_DAMALS_15_03 " );	// And when we reached our goal, he and his friends attacked me.
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_DAMALS_01_04 " );	// Looks like you just got involved with bad people - where was this?
	Info_ClearChoices(dia_bdt_1013_bandit_where);
...
func void dia_bdt_1013_bandit_where_prisoner()
{
	...
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_PRISONER_01_01 " );	// (shocked) Did you come from behind the Barrier? We were there together then.
	AI_Output(other,self, " DIA_BDT_1013_BANDIT_WHERE_PRISONER_15_02 " );	// I don't know you...
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_PRISONER_01_03 " );	// I was a miner at the Old Camp. I almost never got out of the pit.
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_PRISONER_01_04 " );	// But what's more important now is that you're in big trouble!
	...
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_PRISONER_01_09 " );	// Don't mention it. Just try to stay alive.
...
func void dia_bdt_1013_bandit_where_notimportant()
{
	...
	AI_Output(self,other, " DIA_BDT_1013_BANDIT_WHERE_NOTIMPORTANT_01_01 " );	// Ok then. So, are you coming or not?
	Info_ClearChoices(dia_bdt_1013_bandit_where);
	Info_AddChoice(dia_bdt_1013_bandit_where,"Возможно, позже...",dia_bdt_1013_bandit_where_later);
	Info_AddChoice(dia_bdt_1013_bandit_where, " Okay! Go ahead! " ,dia_bdt_1013_bandit_where_yes);
};
...
func void DIA_1013_BANDIT_NAME_Info()
{
	...
	AI_Output(other,self, " DIA_1013_BANDIT_NAME_15_02 " );	// And who was that?
	AI_Output(self,other, " DIA_1013_BANDIT_NAME_01_03 " );	// That's of no importance right now...
	Log_CreateTopic(Topic_Bandits,LOG_MISSION);
	Log_SetTopicStatus(Topic_Bandits,LOG_Running);
	B_LogEntry(Topic_Bandits, " Several bandits are looking for me. They have a wanted post of me. What could this mean? " );
...
func void DIA_1013_BANDIT_DEXTER_Info()
{
	...
	AI_Output(self,other, " DIA_1013_BANDIT_DEXTER_01_01 " );	// A whole ten coins...
	AI_Output(other,self, " DIA_1013_BANDIT_DEXTER_15_02 " );	// Lay it out, quick!
	AI_Output(self,other, " DIA_1013_BANDIT_DEXTER_01_03 " );	// (takes a deep breath) Oh man! His name is Dexter. There is a steep rock near the big farm.
	...
	else
	{
		...
		AI_Output(self,other, " DIA_1013_BANDIT_DEXTER_01_07 " );	// What?! I... Oh - forget it - it's my own fault. Shouldn't have told you anything until I saw the gold...
	};
...
func void DIA_1013_BANDIT_FromMaleth_Info()
{
	...
	{
		AI_Output(other,self, " DIA_1013_BANDIT_FromMaleth_15_04 " );	// He wants you all dead...
		AI_Output(self,other, " DIA_1013_BANDIT_FromMaleth_01_05 " );	// Wait - you wouldn't do this to me, would you, I helped you?
		AI_Output(self,other, " DIA_1013_BANDIT_FromMaleth_01_06 " );	// Go in there and kill the others if you're so bloodthirsty - I'm outta here!
	};
	Bdt_1013_Away = TRUE;
...
func void DIA_1013_BANDIT_FromCavalorn_Info()
{
	...
	AI_Output(self,other,"DIA_ADDON_1013_BANDIT_FromCavalorn_01_01");	//What's happened?
...
func void DIA_1013_BANDIT_PERM_Info()
{
	...
	if (bdt13_Gossip_Wilderness ==  FALSE )
	{
		...
		AI_Output(self,other, " DIA_1013_BANDIT_PERM_01_02 " );	// The further you go into the wilderness, the more dangerous it gets.
...
func void DIA_1013_BANDIT_LeeFarm_Info()
{
	...
	AI_Output(self,other, " DIA_ADDON_1013_BANDIT_LeeFarm_01_03 " );	// I've already thought about that. But there is a small problem.
	...
	AI_Output(other,self, " DIA_ADDON_1013_BANDIT_LeeFarm_01_06 " );	// Then you need to find something else to wear.
	AI_Output(self,other, " DIA_ADDON_1013_BANDIT_LeeFarm_01_07 " );	// Easy to say. Good armor is hard to find around here.
	AI_Output(self,other, " DIA_ADDON_1013_BANDIT_LeeFarm_01_08 " );	// And I will not wear rags.
	AI_Output(other,self, " DIA_ADDON_1013_BANDIT_LeeFarm_01_09 " );	// Okay, I'll try to get you some decent armor.
	AI_Output(self,other, " DIA_ADDON_1013_BANDIT_LeeFarm_01_10 " );	// Thanks mate. Believe me, I will not remain in debt to you for long.
...
func void DIA_1013_BANDIT_LeeFarm_Done_Info()
{
	...
	AI_Output(self,other, " DIA_ADDON_1013_BANDIT_LeeFarm_Done_01_01 " );	// Let me take a look at it. Is it right for me?
